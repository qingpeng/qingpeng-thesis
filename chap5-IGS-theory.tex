...
diversity analysis of large shortgun whole genome metagenomic data possibile. 

We began such efforts by proposing that
 the concept of k-mers(a DNA segment with the leng of k) could be used as the 
 basicto unit to measure
...
abundance in a sample. Then existing estimators like Chao's can be appled to 
...
A-B-C-D respectively. (We call "5-1-2-1" "coverage  spectrum" across samples.)
...
no matter it is abundance-based or incidence-baserd, about richness or about 
evenness.
