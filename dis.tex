...
\title{A Novel Computational Approach to Investigate Microbial Diversity using Whole-genome Shotgun Metagenomic Data} %% Put the title of your dissertation here.
...
Taxonomic Units) based on 16S rRNA genes are used as the foundation for
diversity analysis. We have developed a novel statistical framework to enable microbial diversity
 analysis using whole genome shotgun metagenomic reads data without the
requirement of assembly, binning, reference or annotation. The novel concept
we proposed - IGS represents the
...
data matrix to investigate the diversity.
